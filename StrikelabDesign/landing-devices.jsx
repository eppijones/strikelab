// landing-devices.jsx — compact device mockups used inside the landing hero.
// Smaller, cleaner versions of the phone/watch/web frames — kept here so the
// variant compositions stay readable.
//
// All components consume the TEE palette from components.jsx and are
// designed to render at any size via the `scale` prop.
...
// ─────────────────────────────────────────────────────────────
function MiniPhone({ width = 240, screen, accent = TEE.moss, time = '9:41', tint = TEE.cream }) {
...
// Mini Apple Watch
// ─────────────────────────────────────────────────────────────
function MiniWatch({ width = 168, screen, time = '9:41' }) {
...
function PhoneScreenScorecard({ accent }) {
  return (
    <>
...
function PhoneScreenLiveShot({ accent }) {
  return (
    <>
      <g transform="translate(28, 64)">
...
function PhoneScreenWindow({ accent }) {
  return (
    <>
      <g transform="translate(28, 64)">
...
function PhoneScreenReview({ accent }) {
...
Object.assign(window, {
  MiniPhone, MiniWatch, MiniWebTee,
  PhoneScreenScorecard, PhoneScreenLiveShot, PhoneScreenWindow, PhoneScreenReview,
  WatchScreenShot, WatchScreenHandicap, WatchScreenWindow,
});
